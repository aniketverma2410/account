...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb" style="padding: 0px 5px;">
          ...
          <li><a href="<?php echo base_url('Purchase/viewPurchase');?>">Purchase Orders</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Purchase Order Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="#" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="col-sm-3 form-group">
                  <label for="exampleInputEmail1">Deliver To</label><span style="color: red">*</span><br>
                  <input type="radio" id=""  name="" value="">&nbsp;&nbsp;Organization&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <input type="radio" id=""  name="" value="">&nbsp;&nbsp;Customer
                </div>
                <div class="col-sm-3 form-group">
                  <label for="exampleInputEmail1">Purchase Order</label><span style="color: red">*</span><br>
                  <input class="form-control" type="text" id="" name="" value="" placeholder="PO-00001">
              ...
              <div class="col-sm-12">
                ...
                <div class="col-sm-3 form-group">
                  <label for="exampleInputEmail1">Expected Delivery Date</label><span style="color: red">*</span><br>
                  <div class="input-group date">
                  <div class="input-group-addon">
                    <i class="fa fa-calendar"></i>
                  </div>
                ...
                <div class="col-sm-3 form-group">
                  <label for="exampleInputEmail1">Shipment Preference</label><span style="color: red">*</span>
                  <select class="form-control">
                    <option value="">Choose Shipment Preference</option>
                  </select>
                  <span id="error_name"></span>
                </div>
              </div>
        <div class="col-md-12">
                ...
                <div class="col-sm-12"><br>
                  ...
                  <div class="col-sm-3">
                    <label>Notes</label>
                    <input type="text" name="" class="form-control" placeholder="Will be Display on Purchase Order.">
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="col-sm-4">
