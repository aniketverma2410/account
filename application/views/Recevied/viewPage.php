...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Payments Recevied<small style="font-size: 14px;"><a class="a" href="<?= base_url('Recevied/addRecevied');?>" class="add_user">Add Recevied Payment</a></small>
        </h1>
        <ol class="breadcrumb" style="padding: 0px 5px;">
          <li><a href="<?php echo base_url('Admin/dashboard');?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Recevied Payments</li>
        </ol>
    </section>
    <!-- Main content -->
