...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Add Transaction Locking</h1>
        <ol class="breadcrumb" style="padding: 0px 5px;">
          <li><a href="<?php echo base_url('Admin/dashboard');?>"><i class="fa fa-dashboard"></i> Home</a></li>
          <li><a href="<?php echo base_url('Transaction/viewTransaction');?>">Transactions Locking</a></li>
        <li class="active">Add Transaction Locking</li>
        </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Transaction Locking Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="#" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="col-sm-3 form-group">
                  <label for="exampleInputEmail1">Lock Date</label><span style="color: red">*</span>
                ...
                <div class="col-sm-6 form-group">
                  ...
                  <textarea class="form-control" type="text" id="" name="" value="" placeholder="Max 500 Characters"></textarea>
                </div>
              </div>
                <div class="col-sm-12">
                  <div class="col-sm-4">
