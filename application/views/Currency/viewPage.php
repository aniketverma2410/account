...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Currency Adjustments<small style="font-size: 14px;"><a class="a" href="<?= base_url('Currency/addCurrency');?>" class="add_user">Add Currency Adjustment</a></small>
        </h1>
        <ol class="breadcrumb" style="padding: 0px 5px;">
          <li><a href="<?php echo base_url('Admin/dashboard');?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Currency Adjustments</li>
        </ol>
    </section>
    <!-- Main content -->
