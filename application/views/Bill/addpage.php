...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb" style="padding: 0px 5px;">
          ...
          <li><a href="<?php echo base_url('Bill/viewBill');?>">Bills</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Bill Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="#" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="col-sm-3 form-group">
                  <label for="exampleInputEmail1">Bill</label><span style="color: red">*</span><br>
                ...
                <div class="col-sm-3 form-group">
                  <label for="exampleInputEmail1">Bill Date</label><span style="color: red">*</span><br>
              ...
              <div class="col-sm-12">
                <div class="col-sm-3 form-group">
                  <label for="exampleInputEmail1">Due Date</label><span style="color: red">*</span><br>
                  <div class="input-group date">
                  <div class="input-group-addon">
                    <i class="fa fa-calendar"></i>
                  </div>
                ...
                <div class="col-sm-3 form-group">
                  ...
                  <select class="form-control">
                    ...
                    <option value="6">Due end of the next month</option>
                 ...
                 <table class="table table-bordered table-condensed">
                    ...
                    <tbody id="tbody">
                      <tr id="tr1">
                        ...
                        <td class="tb"><input type="text" name="" id="" class="form-control tbl" placeholder="0.00"></td>
                        <td class="tb"><select class="form-control tbl" name="" id=""><option value="1">Select Customer</option></select></td>
