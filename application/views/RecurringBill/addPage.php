...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb" style="padding: 0px 5px;">
          ...
          <li><a href="<?php echo base_url('RecurringBill/viewRecurringBill');?>">Recurring Bills</a></li>
        <li class="active">Add Recurring Bill</li>
        </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Recurring Bill Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="#" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="col-sm-3 form-group">
                  <label for="exampleInputEmail1">Profile Name</label><span style="color: red">*</span><br>
                ...
                <div class="col-sm-3 form-group">
                  <label for="exampleInputEmail1">Start On</label><span style="color: red">*</span><br>
              ...
              <div class="col-sm-12">
                <div class="col-sm-3 form-group">
                  <label for="exampleInputEmail1">Ends On</label><span style="color: red">*</span><br>
                  <div class="input-group date">
                  <div class="input-group-addon">
                    <i class="fa fa-calendar"></i>
                  </div>
