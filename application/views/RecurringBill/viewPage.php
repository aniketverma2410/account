...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Recurring Bills<small style="font-size: 14px;"><a class="a" href="<?= base_url('RecurringBill/addRecurringBill');?>" class="add_user">Add Recurring Bill</a></small>
        </h1>
        <ol class="breadcrumb" style="padding: 0px 5px;">
          <li><a href="<?php echo base_url('Admin/dashboard');?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Recurring Bills</li>
        </ol>
    </section>
    <!-- Main content -->
