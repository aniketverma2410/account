...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Add Payment Made</h1>
        <ol class="breadcrumb" style="padding: 0px 5px;">
          <li><a href="<?php echo base_url('Admin/dashboard');?>"><i class="fa fa-dashboard"></i> Home</a></li>
          <li><a href="<?php echo base_url('Payment/viewPaymentMade');?>">Payments Made</a></li>
        <li class="active">Add Payment Made</li>
        </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Payment Made Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
